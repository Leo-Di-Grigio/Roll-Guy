package game.state.location.creature;
...
import game.state.location.creature.ai.AIPathFind;
import game.state.location.creature.ai.Perception;
import game.state.location.creature.items.Equipment;
import game.state.location.creature.skills.SkillList;
import game.state.location.creature.struct.Struct;
